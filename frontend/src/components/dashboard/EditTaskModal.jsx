          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <div>
                ...
                <input
                  ...
                  style={{ 
                    ...
                    // Đổi viền input thành màu Cam khi focus
                    border: focusInput ? '2px solid #f59e0b' : '1px solid #cbd5e1', 
                    borderRadius: '8px', outline: 'none', boxSizing: 'border-box', transition: 'all 0.2s',
                    boxShadow: focusInput ? '0 0 0 3px rgba(245, 158, 11, 0.1)' : '0 1px 2px 0 rgba(0, 0, 0, 0.05)'
                  }}
                />
              </div>
            ...
            <div style={{ padding: '16px 24px', background: '#f8fafc', borderTop: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '12px' }}>
              ...
              <button type="submit" disabled={loading}
                // Đổi nút Submit thành màu Cam
                style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 20px', fontSize: '14px', fontWeight: 600, color: 'white', background: loading ? '#fcd34d' : '#f59e0b', border: 'none', borderRadius: '8px', cursor: loading ? 'wait' : 'pointer', transition: 'all 0.2s', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.05)' }}
